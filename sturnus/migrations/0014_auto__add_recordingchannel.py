...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecordingChannel'
        db.create_table('sturnus_recordingchannel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Site'])),
            ('pad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.ElectrodePad'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Region'], null=True, blank=True)),
        ))
        db.send_create_signal('sturnus', ['RecordingChannel'])


    def backwards(self, orm):
        # Deleting model 'RecordingChannel'
        db.delete_table('sturnus_recordingchannel')
