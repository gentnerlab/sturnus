...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Site'
        db.create_table('sturnus_site', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('depth', self.gf('django.db.models.fields.IntegerField')()),
            ('penetration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Penetration'])),
        ))
        db.send_create_signal('sturnus', ['Site'])

        # Adding M2M table for field blocks on 'Site'
        db.create_table('sturnus_site_blocks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('site', models.ForeignKey(orm['sturnus.site'], null=False)),
            ('block', models.ForeignKey(orm['sturnus.block'], null=False))
        ))
        db.create_unique('sturnus_site_blocks', ['site_id', 'block_id'])


    def backwards(self, orm):
        # Deleting model 'Site'
        db.delete_table('sturnus_site')

        # Removing M2M table for field blocks on 'Site'
        db.delete_table('sturnus_site_blocks')
