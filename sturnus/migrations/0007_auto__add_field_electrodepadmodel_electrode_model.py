...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectrodePadModel.electrode_model'
        db.add_column('sturnus_electrodepadmodel', 'electrode_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sturnus.ElectrodeModel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectrodePadModel.electrode_model'
        db.delete_column('sturnus_electrodepadmodel', 'electrode_model_id')
