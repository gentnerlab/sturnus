...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SortQualityMethod'
        db.create_table(u'extracellular_sortqualitymethod', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'extracellular', ['SortQualityMethod'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SortQualityMethod'
        db.delete_table(u'extracellular_sortqualitymethod')
    ...
    models = {
        ...
        u'extracellular.population': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'units': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['extracellular.Unit']", 'symmetrical': 'False'})
        },
        ...
        u'extracellular.unit': {
            'Meta': {'object_name': 'Unit', '_ormbases': [u'broab.Unit']},
