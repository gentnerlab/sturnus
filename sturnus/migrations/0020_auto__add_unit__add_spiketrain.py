...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Unit'
        db.create_table('sturnus_unit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('sturnus', ['Unit'])

        # Adding model 'SpikeTrain'
        db.create_table('sturnus_spiketrain', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('isolation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Isolation'])),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Unit'])),
            ('t_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('t_stop', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('sturnus', ['SpikeTrain'])


    def backwards(self, orm):
        # Deleting model 'Unit'
        db.delete_table('sturnus_unit')

        # Deleting model 'SpikeTrain'
        db.delete_table('sturnus_spiketrain')
    ...
    models = {
        ...
        'sturnus.spiketrain': {
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sturnus.Unit']"})
        },
        'sturnus.stimulus': {
