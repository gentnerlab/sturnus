...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ElectrodePad'
        db.create_table('sturnus_electrodepad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('impedance', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('electrode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Electrode'])),
            ('electrode_pad_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.ElectrodePadModel'])),
        ))
        db.send_create_signal('sturnus', ['ElectrodePad'])

        # Adding model 'Electrode'
        db.create_table('sturnus_electrode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serial_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('sturnus', ['Electrode'])


    def backwards(self, orm):
        # Deleting model 'ElectrodePad'
        db.delete_table('sturnus_electrodepad')

        # Deleting model 'Electrode'
        db.delete_table('sturnus_electrode')
