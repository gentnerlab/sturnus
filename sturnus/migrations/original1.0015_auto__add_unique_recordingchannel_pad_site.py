...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RecordingChannel', fields ['pad', 'site']
        db.create_unique('sturnus_recordingchannel', ['pad_id', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RecordingChannel', fields ['pad', 'site']
        db.delete_unique('sturnus_recordingchannel', ['pad_id', 'site_id'])
