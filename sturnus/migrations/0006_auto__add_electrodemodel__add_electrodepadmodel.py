...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sturnus_electrodemodel', (
        ...
        db.send_create_signal('sturnus', ['ElectrodeModel'])

        # Adding model 'ElectrodePadModel'
        db.create_table('sturnus_electrodepadmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size', self.gf('django.db.models.fields.IntegerField')()),
            ('x_coord', self.gf('django.db.models.fields.IntegerField')()),
            ('y_coord', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('sturnus', ['ElectrodePadModel'])


    def backwards(self, orm):
        # Deleting model 'ElectrodeModel'
        db.delete_table('sturnus_electrodemodel')

        # Deleting model 'ElectrodePadModel'
        db.delete_table('sturnus_electrodepadmodel')
