...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.is_part_of'
        db.add_column('sturnus_region', 'is_part_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Region'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.is_part_of'
        db.delete_column('sturnus_region', 'is_part_of_id')
    ...
    models = {
        ...
        'sturnus.region': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_part_of': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sturnus.Region']", 'null': 'True'}),
