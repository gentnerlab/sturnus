...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SortChannel.order'
        db.add_column('sturnus_sortchannel', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding unique constraint on 'SortChannel', fields ['sort', 'order']
        db.create_unique('sturnus_sortchannel', ['sort_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'SortChannel', fields ['sort', 'order']
        db.delete_unique('sturnus_sortchannel', ['sort_id', 'order'])

        # Deleting field 'SortChannel.order'
        db.delete_column('sturnus_sortchannel', 'order')
