...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Isolation'
        db.create_table('sturnus_isolation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num_units', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ...
            ('primary_chan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.RecordingChannel'])),
        ))
        db.send_create_signal('sturnus', ['Isolation'])


    def backwards(self, orm):
        # Deleting model 'Isolation'
        db.delete_table('sturnus_isolation')
