...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sturnus_eventtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('sturnus', ['EventType'])

        # Adding model 'Event'
        db.create_table('sturnus_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.Trial'])),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sturnus.EventType'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=225)),
        ))
        db.send_create_signal('sturnus', ['Event'])


    def backwards(self, orm):
        # Deleting model 'EventType'
        db.delete_table('sturnus_eventtype')

        # Deleting model 'Event'
        db.delete_table('sturnus_event')
